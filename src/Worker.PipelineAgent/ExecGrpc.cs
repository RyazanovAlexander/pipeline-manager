...
namespace Exec {
  public static partial class ExecService
  {
    ...
    static readonly grpc::Marshaller<global::Exec.ExecCommand> __Marshaller_exec_ExecCommand = grpc::Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, global::Exec.ExecCommand.Parser));
    ...
    static readonly grpc::Method<global::Exec.ExecCommand, global::Exec.ExecResult> __Method_ExecuteCommand = new grpc::Method<global::Exec.ExecCommand, global::Exec.ExecResult>(
        grpc::MethodType.Unary,
        __ServiceName,
        "ExecuteCommand",
        __Marshaller_exec_ExecCommand,
    ...
    {
      public virtual global::System.Threading.Tasks.Task<global::Exec.ExecResult> ExecuteCommand(global::Exec.ExecCommand request, grpc::ServerCallContext context)
      {
    ...
    public partial class ExecServiceClient : grpc::ClientBase<ExecServiceClient>
    {
      ...
      public virtual global::Exec.ExecResult ExecuteCommand(global::Exec.ExecCommand request, grpc::Metadata headers = null, global::System.DateTime? deadline = null, global::System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
      {
        return ExecuteCommand(request, new grpc::CallOptions(headers, deadline, cancellationToken));
      }
      public virtual global::Exec.ExecResult ExecuteCommand(global::Exec.ExecCommand request, grpc::CallOptions options)
      {
        return CallInvoker.BlockingUnaryCall(__Method_ExecuteCommand, null, options, request);
      }
      public virtual grpc::AsyncUnaryCall<global::Exec.ExecResult> ExecuteCommandAsync(global::Exec.ExecCommand request, grpc::Metadata headers = null, global::System.DateTime? deadline = null, global::System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
      {
        return ExecuteCommandAsync(request, new grpc::CallOptions(headers, deadline, cancellationToken));
      }
      public virtual grpc::AsyncUnaryCall<global::Exec.ExecResult> ExecuteCommandAsync(global::Exec.ExecCommand request, grpc::CallOptions options)
      {
    ...
    {
      serviceBinder.AddMethod(__Method_ExecuteCommand, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::Exec.ExecCommand, global::Exec.ExecResult>(serviceImpl.ExecuteCommand));
    }
